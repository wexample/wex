...
class TestTestCommandCommandExtensionYaml(AbstractTestCase):
    def test_yaml(self) -> None:
        ...
        self.assertResponseOutputBagItemContains(response, 3, "SIMPLE_SHELL_FILE_RESPONSE")
        ...
        self.assertResponseOutputBagItemContains(response, 7, "SIMPLE_PYTHON_FILE_RESPONSE")
