...
from addons.test.command.return_type.function import \
    test__return_type__function
...
class TestTestCommandReturnTypeFunction(AbstractTestCase):
    def test_function(self):
        self.for_each_render_mode(self._test_function, {
    ...
    def _test_function(self, render_mode):
        response = self.kernel.run_function(test__return_type__function, {
            'arg': 'test'
