...
def __core__core__uninstall_webhook_server(kernel) -> None:
...
def __core__core__uninstall_autocomplete(kernel) -> None:
...
def __core__core__uninstall_terminal(kernel) -> None:
