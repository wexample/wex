...
from src.const.types import OptionalCoreCommandArgsDict, ResponsePrintType, StringsList, ShellCommandsDeepList, \
    ShellCommandsList
...
class InteractiveShellCommandResponse(AbstractResponse):
    def __init__(
        self, kernel: "Kernel", shell_command: ShellCommandsDeepList | ShellCommandsList, ignore_error: bool = False
    ) -> None:
