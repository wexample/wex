...
WEX_ADDONS=(app docker language prompt services-db services-php services-various system)
...
if [ "$(_wexUserIsSudo)" = "false" ]; then
  ...
  WEX_RUNNER_SSH_AUTH_SOCK=${SSH_AUTH_SOCK}
...
WEX_RUNNER_SSH_AUTH_SOCK=${WEX_RUNNER_SSH_AUTH_SOCK} \
...
export WEX_CORE_VERSION=4.0.32
